...
Version  : 1.6.8.1
Release  : 38
URL      : https://cran.r-project.org/src/contrib/lava_1.6.8.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lava_1.6.8.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604545487
