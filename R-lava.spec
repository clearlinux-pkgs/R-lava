...
Version  : 1.6.4
Release  : 17
URL      : https://cran.r-project.org/src/contrib/lava_1.6.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lava_1.6.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1543237258
